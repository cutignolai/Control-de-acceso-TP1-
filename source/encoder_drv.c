...
//Def del timer
static tim_id_t encoder_timer;              //VERRRRRRR
...
void initEncoder() {
	...
	encoder_timer = timerGetId();               //VERRRRRR
	...
	timerStart(encoder_timer, TIMER_MS2TICKS(1), TIM_MODE_PERIODIC, callback_encoder);      //VERRRRRRRRRRRR
}
